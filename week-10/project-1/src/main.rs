...
fn main() {
    ...
    let total_cost_hp = hp.calculate_cost(3);
    let total_cost_ibm = ibm.calculate_cost(3);
    let total_cost_toshiba = toshiba.calculate_cost(3);
    let total_cost_dell = dell.calculate_cost(3);
